                ...
                <div class="account-card">
                  <div class="header-top-account-info">
                    ...
                    <div class="account-body">
                      <h5><a href="{{ url('') }}">{{ $result->username }}</a></h5>
                      <span class="mail">{{ $result->email }}</span>
                    </div>
                  </div>
                  <ul class="account-item-list">
                    <li class="active"><a href="{{ url('') }}"><span class="ti-user"></span>Account</a></li>
                    <li><a href="{{ url('') }}"><span class="ti-settings"></span>Settings</a></li>
                    <li><a href="{{ url('log-out') }}"><span class="ti-power-off"></span>Log Out</a></li>
                  </ul>
                </div>
              </div>
              <select class="selectpicker select-language" data-width="fit">
                <option checked data-content='<span class="flag-icon flag-icon-us"></span> English'>English</option>
              </select>
            </div>
          </div>
